...
wr[wr==0] <- NA
colMeans(wr, na.rm=TRUE)
wr$fortyyd[is.na(wr$fortyyd)] <- 4.480253
wr$twentyss[is.na(wr$twentyss)] <- 4.186833
wr$vertical[is.na(wr$vertical)] <- 35.970320
wr$broad[is.na(wr$broad)] <- 121.224390
wr$threecone[is.na(wr$threecone)] <- 6.901545
wr
